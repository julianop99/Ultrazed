...
--Date        : Mon Sep 16 13:37:07 2019
--Host        : EURW151931 running 64-bit major release  (build 9200)
--Command     : generate_target ultrazed_hdl_wrapper.bd
--Design      : ultrazed_hdl_wrapper
...
entity ultrazed_hdl_wrapper is
  port (
...
end ultrazed_hdl_wrapper;

architecture STRUCTURE of ultrazed_hdl_wrapper is
  component ultrazed_hdl is
  port (
...
ultrazed_hdl_i: component ultrazed_hdl
     port map (
