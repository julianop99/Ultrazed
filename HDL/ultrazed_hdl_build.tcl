...
#
# ultrazed_hdl_build.tcl: Tcl script for re-creating project 'ultrazed_hdl'
#
# Generated by Vivado on Mon Sep 16 14:21:07 +0100 2019
...
#
# 1. This project restoration tcl script (ultrazed_hdl_build.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Xilinx/project/ultrazed/ultrazed_hdl.srcs/sources_1/imports/hdl/ultrazed_hdl_wrapper.vhd"
#    "C:/Xilinx/project/ultrazed/ultrazed_hdl.srcs/sources_1/ip/system_management_wiz_0/system_management_wiz_0.xci"
#    "C:/Xilinx/project/ultrazed/ultrazed_hdl.srcs/constrs_1/imports/github/uz_iocc_sensor.xdc"
#
...
set _xil_proj_name_ "ultrazed_hdl"
...
set script_file "ultrazed_hdl_build.tcl"
...
# Create project
create_project ${_xil_proj_name_} "/Xilinx/project/ultrazed/" -part xczu3eg-sfva625-1-i
...
set_property -name "board_part_repo_paths" -value "C:/Users/317488/bdf" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/ultrazed_hdl.srcs/sources_1/bd/ultrazed_hdl/hdl/ultrazed_hdl_wrapper.vhd"]\
 [file normalize "${origin_dir}/ultrazed_hdl.srcs/sources_1/ip/system_management_wiz_0/system_management_wiz_0.xci"]\
]
...
set file "hdl/ultrazed_hdl_wrapper.vhd"
...
set_property -name "top" -value "ultrazed_hdl_wrapper" -objects $obj
...
set file "[file normalize ${origin_dir}/uz_iocc_sensor.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "github/uz_iocc_sensor.xdc"
...
# Proc to create BD ultrazed_hdl
proc cr_bd_ultrazed_hdl { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name ultrazed_hdl
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Feedback Clk#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO0 MIO#I2C 1#I2C 1#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#UART 1#UART 1#UART 0#UART 0#CAN 1#CAN 1#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#CAN 0#CAN 0#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#clk_for_lpbk#n_ss_out_upper#mo_upper[0]#mo_upper[1]#mo_upper[2]#mo_upper[3]#sclk_out_upper#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#gpio0[23]#scl_out#sda_out#gpio1[26]#gpio1[27]#gpio1[28]#gpio1[29]#gpio1[30]#gpio1[31]#txd#rxd#rxd#txd#phy_tx#phy_rx#gpio1[38]#gpio1[39]#gpio1[40]#gpio1[41]#phy_rx#phy_tx#sdio1_wp#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
   ...
   CONFIG.PSU__CAN1__PERIPHERAL__IO {MIO 36 .. 37} \
   ...
   CONFIG.PSU__CRF_APB__DDR_CTRL__ACT_FREQMHZ {524.994750} \
   ...
   CONFIG.PSU__CRL_APB__CAN0_REF_CTRL__ACT_FREQMHZ {24.999750} \
   CONFIG.PSU__CRL_APB__CAN0_REF_CTRL__DIVISOR0 {21} \
   CONFIG.PSU__CRL_APB__CAN0_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__CAN0_REF_CTRL__FREQMHZ {25} \
   CONFIG.PSU__CRL_APB__CAN0_REF_CTRL__SRCSEL {DPLL} \
   CONFIG.PSU__CRL_APB__CAN1_REF_CTRL__ACT_FREQMHZ {24.999750} \
   CONFIG.PSU__CRL_APB__CAN1_REF_CTRL__DIVISOR0 {21} \
   CONFIG.PSU__CRL_APB__CAN1_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__CAN1_REF_CTRL__FREQMHZ {25} \
   CONFIG.PSU__CRL_APB__CAN1_REF_CTRL__SRCSEL {DPLL} \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {78.946579} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR0 {19} \
  ...
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports jx2_jf_pmod_iic] [get_bd_intf_pins axi_iic_0/IIC]
  connect_bd_intf_net -intf_net axi_iic_1_IIC [get_bd_intf_ports arduino_iic] [get_bd_intf_pins axi_iic_1/IIC]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins axi_quad_spi_0/AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins axi_iic_1/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  ...
  connect_bd_net -net In3_0_1 [get_bd_ports LSM6DS0_INT1] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net In4_0_1 [get_bd_ports LPS25H_INT1] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net In5_0_1 [get_bd_ports HTS221_DRDY] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net In6_0_1 [get_bd_ports LIS3MDL_INT1] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net In7_0_1 [get_bd_ports LIS3MDL_DRDY] [get_bd_pins xlconcat_0/In7]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_iic_1/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_iic_1/s_axi_aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x80004000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_iic_1/S_AXI/Reg] SEG_axi_iic_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x80010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_quad_spi_0/AXI_LITE/Reg] SEG_axi_quad_spi_0_Reg
...
# End of cr_bd_ultrazed_hdl()
cr_bd_ultrazed_hdl ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files ultrazed_hdl.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files ultrazed_hdl.bd ] 
set_property IS_ENABLED "1" [get_files ultrazed_hdl.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files ultrazed_hdl.bd ] 
set_property IS_LOCKED "0" [get_files ultrazed_hdl.bd ] 
set_property IS_MANAGED "0" [get_files ultrazed_hdl.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files ultrazed_hdl.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files ultrazed_hdl.bd ] 
set_property PFM_NAME "" [get_files ultrazed_hdl.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files ultrazed_hdl.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files ultrazed_hdl.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files ultrazed_hdl.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files ultrazed_hdl.bd ] 
set_property USED_IN_SIMULATION "1" [get_files ultrazed_hdl.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files ultrazed_hdl.bd ] 
